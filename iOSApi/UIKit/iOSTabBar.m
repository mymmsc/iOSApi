...
@implementation iOSTabBar
@synthesize tabs, selectedTab, backgroundImage, arrow, delegate;

- (id)initWithFrame:(CGRect)aFrame {

	if (self = [super initWithFrame:aFrame]) {
		self.backgroundImage = [UIImage imageNamed:@"TabBarController.bundle/tab-bar-background.png"];
		self.arrow = [[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"TabBarController.bundle/tab-arrow.png"]] autorelease];
...
- (void)setSelectedTab:(iOSTab *)aTab {

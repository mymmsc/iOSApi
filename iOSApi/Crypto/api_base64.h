 ...
 * The api_vsnprintf/api_snprintf functions are based on, and used with the
 ...
 * trailing \0
 */ 
int api_base64_encode_len(int len) __attribute__((pure));
 ...
 */ 
int api_base64_encode(char * coded_dst, const char *plain_src, 
                                   int len_plain_src)
 ...
 * @return the length of the encoded string, including the trailing \0
 */ 
int api_base64_encode_binary(char * coded_dst,
 ...
 */ 
int api_base64_decode_len(const char * coded_src)
 ...
 */ 
int api_base64_decode(char * plain_dst, const char *coded_src)
                 __attribute__((nonnull(1,2)));
 ...
 */ 
int api_base64_decode_binary(unsigned char * plain_dst, 
